...
Message.create!([ 
  ...
  {text:"Hey whats up you have time now?", user_id: user1.id, conversation_id: conversation1.id },
  {text:"ill be availible in 20 min that work?", user_id: user2.id, conversation_id: conversation1.id },
  {text:"yeah message me im going to get my stuff ready", user_id: user1.id, conversation_id: conversation1.id },
  {text:"example message", user_id: user2.id, conversation_id: conversation2.id },
  {text:"I can really use help with that problem", user_id: user3.id, conversation_id: conversation3.id },
  {text:"Sure would love to help", user_id: user1.id, conversation_id: conversation3.id },
  {text:"Great what time are you availible", user_id: user3.id, conversation_id: conversation3.id },
])
